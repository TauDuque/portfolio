  ...
  return (
    <div className="project-detail-page-container">
      ...
      <section className="project-hero-visual">
        <img
          src="/src/public/assets/images/monitor_portada.png" // Substitua pelo caminho da sua imagem hero
      ...
      <div className="project-content-wrapper">
        ...
        <section className="visual-showcase single-item">
          <div className="visual-item">
            <img
              src="/src/public/assets/images/monitor_detalhe.png" // Substitua pelo caminho do seu screenshot
