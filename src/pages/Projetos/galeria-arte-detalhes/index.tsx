  ...
  return (
    <div className="project-detail-page-container">
      ...
      <section className="project-hero-visual">
        <img
          src="assets/images/galeria_portada.png" // Substitua pelo caminho da sua imagem
      ...
      <div className="project-content-wrapper">
        ...
        <section className="visual-showcase">
          <div className="visual-item">
            <img
              src="/assets/gifs/gif_galeria_1.gif" // Substitua pelo caminho do seu GIF
        ...
        <section className="visual-showcase single-item">
          ...
          <div className="visual-item">
            <img
              src="/assets/images/galeria_2.png" // Substitua pelo caminho do seu screenshot
